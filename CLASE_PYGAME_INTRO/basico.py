...
fondo_homero=pygame.image.load("fondo_homero.jpg")
fondo_homero=pygame.transform.scale(fondo_homero,(ANCHO_VENTANA,ALTO_VENTANA))
...
while flag_run:
    ...
    ventana_ppal.blit(fondo_homero,(0,0))
